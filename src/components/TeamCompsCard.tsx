  ...
  const children: ReactNode = (
    <div>
      ...
      >
        ...
        >
          ...
          <div className='flex items-center justify-center'>
            <Link to={'/champion'}>
              <img
                className='w-[36px] mr-4 border-[1px] border-solid border-[var(--border-5c-clr)] hover:border-orange-500'
            ...
            <Link to={'/champion'}>
              <img
                className='w-[36px] border-[1px] border-solid border-[var(--border-5c-clr)] hover:border-orange-500'
      ...
      <div className='grid grid-cols-2'>
          ...
          <div className='flex'>
            ...
            <div>
              <div className='flex items-center mb-4'>
                ...
                >
                  <img
                    className='w-[36px] border-[1px] border-solid border-[var(--border-5c-clr)] hover:border-orange-500 mr-4'
        ...
        <div className='flex flex-col items-center py-4'>
          <span className='text-[#88A0A7] mb-4'>Positioning</span>
          <ChessBoard
            size='small'
            tile3={
              <img
